...
import com.video.utils.IpUtils;
...
public class WebSecurityHandler implements HandlerInterceptor {
        ...
        if (handler instanceof HandlerMethod) {
            ...
            if (accessLimit != null) {
                ...
                try {
                    ...
                    if (q > maxCount) {
                        render(httpServletResponse, BaseResponse.error("请求过于频繁，请稍候再试"));
    ...
    private void render(HttpServletResponse response, BaseResponse result) throws Exception {
