...
public class SendMail {
    ...
    // 发件人的邮箱账号
    public static String sendEmailAccount = "1002800982@qq.com";
    // 发件人的邮箱的授权码
    public static String sendEmailPassword = "dhszwwzhjbxbbcha";
    // 发件人邮箱的SMTP服务器地址
    public static String sendEmailSMTPHost = "smtp.qq.com";
    // 收件人的邮箱账号

    // 把发送邮件封装为方法，参数为收件人的邮箱账号和要发送的内容--》自己写可以是random随机生成验证码
    public void sendMail(String receiveMailAccount, String mailContent) {
        // 创建用于连接邮件服务器的参数配置
        //Properties就可以用来设置配置信息
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,
        ...
        // 设置发件人姓名和编码格式
        message.setFrom(new InternetAddress(sendMail, "**视频", "UTF-8"));
